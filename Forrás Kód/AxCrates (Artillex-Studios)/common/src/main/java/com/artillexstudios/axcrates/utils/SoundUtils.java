...
public class SoundUtils {
    ...
    public static void playSound(@NotNull Player player, @Nullable String sound) {
        ...
        try {
            ...
            Bukkit.getConsoleSender().sendMessage(StringUtils.formatToString("&#FF0000[AxCrates] A hang %sound% nem létezik, ez lehet egy konfiguráció hiba!".replace("%sound%", sound)));
        }
    }
}